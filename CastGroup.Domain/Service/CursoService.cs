...
namespace CastGroup.Domain.Service
{
    public class CursoService : ICursoService
    {
        ...
        {
            var periodoCurso =  await _cursoRepository.VerificaPeriodoCurso(curso.DataInicio, curso.DataFim);
        ...
        public async Task Atualizar(Curso curso)
        {
            ...
            var cursoCadastrado = await _cursoRepository.ObterCursoPorId(curso.Id);

            curso.CodigoCategoria = cursoCadastrado.CodigoCategoria;
            if(periodoCurso != null)
